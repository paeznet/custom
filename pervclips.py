...
####  Falla Thumb      https://cdn.pervclips.com/tube/contents/videos_screenshots/1063708000/1063708942/367x275/3.jpg?ver=3
...
def search(item, texto):
    ...
    item.url = "%s/tube/search/latest/?q=%s" % (host,texto)
    try:
        return lista(item)
    except:
        import sys
