...
def mainlist(item):
    ...
    itemlist.append(Item(channel=item.channel, title="Canal" , action="catalogo", url=host + "channels/?sort_by=total_videos&from=01"))
...
def lista(item):
    ...
    for elem in matches:
        ...
        if elem.find('span', class_='ico-private'):
