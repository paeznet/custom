...
##############  SERVER NETU y https://veev.to/e/25wXbWyjlGhtCphCKjOrrF8IQHDAsndzIhwQ9Ar


canonical = {
             'channel': 'italianvidxxx', 
             'host': config.get_setting("current_host", 'italianvidxxx', default=''), 
             'host_alt': ["https://italianvidxxx.com/"], 
             'host_black_list': [], 
...
finds = {'find': dict([('find', [{'tag': ['div'], 'class': ['videos-list']}]),
        ...
        # {'find_all': [{'tag': ['article'], 'class': re.compile(r"^post-\d+")}]},
         ...
         # 'findvideos': {'find_all': [{'tag': ['a'], 'title': ['Streaming']}]},
         'findvideos': {},
