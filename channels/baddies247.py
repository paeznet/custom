...
canonical = {
             'channel': 'baddies247', 
             'host': config.get_setting("current_host", 'baddies247', default=''), 
             'host_alt': ["https://baddies247.com/"], 
             'host_black_list': [], 
             'pattern': ['base href="([^"]+)"'], 
...
def mainlist(item):
    logger.info()
    itemlist = []
    itemlist.append(Item(channel=item.channel, title="baddies247" , action="submenu", url= "https://baddies247.com/", chanel="baddies247", thumbnail = "https://baddies247.com/static/images/baddies247.png"))
    itemlist.append(Item(channel=item.channel, title="baddiesonly" , action="submenu", url= "https://baddiesonly.tv/", chanel="baddiesonly", thumbnail = "https://baddiesonly.tv/static/images/BaddiesOnlyFinal.png"))
