...
def play(item):
    ...
    if soup.find('div', id='box-video-bottom').find_all('a', href=re.compile("/pornostar/[A-z0-9-]+/")):
        pornstars = soup.find('div', id='box-video-bottom').find_all('a', href=re.compile("/pornostar/[A-z0-9-]+/"))
