...
# https://www.sexoasis.com https://www.youngpornvideos.com   https://www.movieshark.com    https://www.mobilepornmovies.com
canonical = {
             'channel': 'mobilepornmovies', 
             'host': config.get_setting("current_host", 'mobilepornmovies', default=''), 
             'host_alt': ["https://www.mobilepornmovies.com"], 
             'host_black_list': [], 
...
def mainlist(item):
    ...
    itemlist.append(Item(channel=item.channel, title="Canal" , action="categorias", url=host + "/channels/?sort=rate"))
...
def categorias(item):
    ...
    next_page = soup.find('div', class_='pagination').find('a', class_='active')
