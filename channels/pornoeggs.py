...
# https://www.peekvids.com/   https://www.playvids.com/   https://www.pornoeggs.com/

canonical = {
             'channel': 'pornoeggs', 
             'host': config.get_setting("current_host", 'pornoeggs', default=''), 
             'host_alt': ["https://www.pornoeggs.com/"], 
             'host_black_list': [], 
