...
def mainlist(item):
    ...
    itemlist.append(Item(channel=item.channel, title="Productora" , action="section", url=host + "sites/?sort_by=total_videos&from=1", extra="Sitios"))
