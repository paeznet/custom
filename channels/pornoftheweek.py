...
canonical = {
             'channel': 'pornoftheweek', 
             'host': config.get_setting("current_host", 'pornoftheweek', default=''), 
             'host_alt': ["https://pornoftheweek.com/"], 
             'host_black_list': [], 
...
def mainlist(item):
    ...
    # itemlist.append(Item(channel=item.channel, title="JAV" , action="list_all", url=host + "category/japanhdv/"))
    # itemlist.append(Item(channel=item.channel, title="Jacquie et Michel" , action="list_all", url=host + "category/jacquieetmicheltv-videos/page/1/?filter=latest"))
