...
#   https://freshporno.net/       https://kojka.com/

canonical = {
             'channel': 'kojka', 
             'host': config.get_setting("current_host", 'kojka', default=''), 
             'host_alt': ["https://kojka.com/"], 
             'host_black_list': [], 
...
finds = {'find': {'find_all': [{'tag': ['div'], 'class': 'thumbs-inner'}]},
         ...
         'url_replace': [], 
         'controls': {'url_base64': False, 'cnt_tot': 49, 'reverse': False, 'profile': 'default'}, 
         'timeout': timeout}
