...
canonical = {
             'channel': 'poldertubenl', 
             'host': config.get_setting("current_host", 'poldertubenl', default=''), 
             'host_alt': ["https://www.poldertube.nl/"], 
             'host_black_list': [], 
...
def mainlist(item):
    ...
    itemlist.append(Item(channel=item.channel, title="Pornstars" , action="section", url=host + "nederlandse-porno-sterren-acteurs-actrices/page/1/", extra="PornStar"))
    itemlist.append(Item(channel=item.channel, title="Categorias" , action="section", url=host + "categorieen/page/1/", extra="Categorias"))
