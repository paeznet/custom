...
def mainlist(item):
    ...
    itemlist.append(item.clone(title="Mas vistos" , action="lista", url=host + "?do=most-viewed&th=month"))
    itemlist.append(item.clone(title="Mejor valorado" , action="lista", url=host + "?do=most-rated&th=month"))
    itemlist.append(item.clone(title="1080-4K" , action="lista", url=host + "?do=1080-4k"))
    # itemlist.append(item.clone(title="Mas comentados" , action="lista", url=host + "/most-discussed/")) 
    itemlist.append(item.clone(title="Canal" , action="catalogo", url=host + "channels"))
    itemlist.append(item.clone(title="PornStar" , action="pornstar", url=host + "pornstars?do=most-rated"))
